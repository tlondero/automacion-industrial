...
%Se le agregó un observador al control integral, teniendo la salvedad %que para el observador se tom\'o como salida tanto la posici\'on %como el \'angulo, y para la realimentaci\'on integral se uso C como %solo la posici\'on. Obteniendo lo siguientes resultados:
