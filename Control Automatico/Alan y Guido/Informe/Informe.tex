...
\section{Carro con Péndulo Simple: Control por realimentaci\'on de estados.}
 Para la realimentación de estados se tomaron al igual que en loop shaping las matrices producto de la linealizacion de la planta. Se probo que esta sea controlable y observable teniendo como salida el \'angulo y posici\'on del carrito. Y finalmente se realizo una realimetnacion de estados colocando los polos del sistema doble en -3 y doble en -2. Ademas se diseño un observador de estados  para el sistema que permita realizar la realimentación de estados mirando la salida.
\end{document}
