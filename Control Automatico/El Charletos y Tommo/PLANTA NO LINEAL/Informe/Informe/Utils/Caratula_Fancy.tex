...
\begin{tabular}{llr} 
	...
	& \textbf{Maselli, Carlos} & \textbf{(Leg. N}$\mathbf{^o}$ \textbf{59564)} \\
	
 &  & \\
 &  & \\
	\textbf{DOCENTES}:
	& \textbf{Ghersin, Alejandro Simon} & \\
...
{\noindent \setparagraphsize{12}{\textbf{\textsc{22.93 - Control Automático}}}}
}
\vspace*{1.5cm}

\center{\textbf{BUENOS AIRES}}
\center{\textbf{PRIMER CUATRIMESTRE, 2022}}
