function [green_filter_l,green_filter_l2, green_filter_l3,red_filter_l]=filterImage(foto,hsv_sat_lo,hsv_val_hi,hsv_val_lo)
% FILTERIMAGE Realiza un filtrado de la imagen que se le provea, 
%     [green_filter_l,red_filter_l]=filterImage(foto) Devuelve los filtros verde y rojo de la imagen original
